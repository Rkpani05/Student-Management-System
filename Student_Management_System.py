...
# Database coding
connector = sqlite3.connect('Student_Management_System.db')
...
# GUI window
main = Tk()
main.title('RKs Student Management Software')
...
Label(left_frame, text="Contact Number", font=labelfont, bg=lf_bg).place(relx=0.2, rely=0.18)
Label(left_frame, text="Email Address", font=labelfont, bg=lf_bg).place(relx=0.275, rely=0.31)
Label(left_frame, text="Gender", font=labelfont, bg=lf_bg).place(relx=0.375, rely=0.44)
Label(left_frame, text="Date of Birth (DOB)", font=labelfont, bg=lf_bg).place(relx=0.22, rely=0.57)
Label(left_frame, text="Stream", font=labelfont, bg=lf_bg).place(relx=0.375, rely=0.7)
Entry(left_frame, width=19, textvariable=name_strvar, font=entryfont).place(x=55, rely=0.1)
Entry(left_frame, width=19, textvariable=contact_strvar, font=entryfont).place(x=55, rely=0.23)
Entry(left_frame, width=19, textvariable=email_strvar, font=entryfont).place(x=55, rely=0.36)
Entry(left_frame, width=19, textvariable=stream_strvar, font=entryfont).place(x=55, rely=0.75)
OptionMenu(left_frame, gender_strvar, 'Male', "Female").place(x=55, rely=0.49, relwidth=0.5)
dob = DateEntry(left_frame, font=("Arial", 12), width=15)
dob.place(x=55, rely=0.62)
Button(left_frame, text='Submit and Add Record', font=labelfont, command=add_record, width=18).place(x= 55, rely=0.85)

# center frame
Button(center_frame, text='Delete Record', font=labelfont, command=remove_record, width=15).place(relx=0.25, rely=0.25)
Button(center_frame, text='View Record', font=labelfont, command=view_record, width=15).place(relx=0.25, rely=0.35)
Button(center_frame, text='Reset Fields', font=labelfont, command=reset_fields, width=15).place(relx=0.25, rely=0.45)
Button(center_frame, text='Delete database', font=labelfont, command=reset_form, width=15).place(relx=0.25, rely=0.55)
